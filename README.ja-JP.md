...
> **ステータス：初期研究プロトタイプ — Phase 5 拡張自己修正ループ (v0.4.0)**

DSCNS は、ニューラルシステムが自身の状態を継続的に観察し、自身のパラメータを
修正し、修正の結果を評価し、失敗した修正から学び、長期にわたって繰り返し自身を
適応させることができるかどうかを探求する実験的研究プロトタイプです。
...
> DSCNS — Dynamic Self-Modifying Cognitive Network System (v0.4.0)、
